...
# Model (APTM™).
#
# https://fuadkpm1980.shinyapps.io/capstone/
#
# Requires:
#    predictNext.R
#    tokenizer.R
...
ui <- fluidPage(
    ...
    HTML(paste0(
        ...
        "<a href=\"https://github.com/fuadkpm1980/Capstone-Final-Project-\">GitHub</a>.<br>",
        "Link to the presentation ",
        "<a href=\"http://rpubs.com/fuadkpm1980/project_capstone\">Fuad Mohamad</a>."
